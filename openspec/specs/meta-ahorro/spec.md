...
Permite al usuario configurar una meta de ahorro mensual como porcentaje de su sueldo, auto-detectar el sueldo desde los ingresos del mes, calcular cuánto ahorró en el mes actual, y visualizar el progreso mediante una card semafórica en el Dashboard.
