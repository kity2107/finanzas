# Spec: gastos-fijos-auto

## Purpose

Auto-generación de gastos fijos al iniciar sesión: verifica si el mes actual ya fue procesado y, de no ser así, inserta en la hoja `Gastos` una fila por cada `GastoFijo` activo, evitando duplicados y notificando al usuario.
